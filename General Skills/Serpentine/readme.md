Verilen python programını indirip çalıştırdığımızda bize boş cevaplar dönüyor . Bu yüzden kodları incelemeye koyuluyoruz . Baktığımızda aslında bizim için önemli olan kısım şurası :
